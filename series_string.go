...
func NewSeriesString(name string, size int, capacity int, vals ...interface{}) *SeriesString {
	s := &SeriesString{
		name:   name,
		Values: []*string{},
	}
...
func (s *SeriesString) SortLessFunc() func(val1 interface{}, val2 interface{}) bool {
...
func (s *SeriesString) SortEqualFunc() func(val1 interface{}, val2 interface{}) bool {
	return func(val1 interface{}, val2 interface{}) bool {
		t1 := val1.(string)
		t2 := val2.(string)
