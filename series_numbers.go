...
func NewSeriesFloat64(name string, size int, capacity int, vals ...interface{}) *SeriesFloat64 {
	s := &SeriesFloat64{
		name:   name,
		Values: []*float64{},
	}
...
func (s *SeriesFloat64) SortLessFunc() func(val1 interface{}, val2 interface{}) bool {
...
func (s *SeriesFloat64) SortEqualFunc() func(val1 interface{}, val2 interface{}) bool {
	return func(val1 interface{}, val2 interface{}) bool {
		t1 := val1.(float64)
		t2 := val2.(float64)
...
type SeriesInt64 struct {
	...
	lock   sync.RWMutex
	name   string
	Values []*int64 // "NaN" is set using nil
}

// NewSeriesInt64 creates a new series with the underlying type as int64
func NewSeriesInt64(name string, size int, capacity int, vals ...interface{}) *SeriesInt64 {
	s := &SeriesInt64{
		name:   name,
		Values: []*int64{},
	}
...
func (s *SeriesInt64) SortLessFunc() func(val1 interface{}, val2 interface{}) bool {
	return func(val1 interface{}, val2 interface{}) bool {
		t1 := val1.(int64)
		t2 := val2.(int64)
...
func (s *SeriesInt64) SortEqualFunc() func(val1 interface{}, val2 interface{}) bool {
	return func(val1 interface{}, val2 interface{}) bool {
		t1 := val1.(int64)
		t2 := val2.(int64)
